...
import { EXTRACT_MODEL, MAX_OUTPUT_TOKENS, MAX_CONCURRENT_CALLS, MAX_BATCHES_PER_PAGE } from "../adapters/llmExtract.js";
import { DISCOVERY_MODEL, MAX_CANDIDATE_FETCHES, MAX_KEPT_URLS, MAX_EVALUATIONS, MAX_SITEMAP_CANDIDATES, URL_BATCH_SIZE, URL_BATCH_CONCURRENCY, CONCURRENT_HOSTS as CONCURRENT_HOSTS_99, MIN_TEXT_LENGTH, MIN_DATE_HITS, MIN_DATED_TO_PROMOTE, MIN_UPCOMING_TO_PROMOTE, MAX_PAST_RATIO } from "../adapters/probe.js";
import { MODEL } from "../adapters/discover.js";
import { MODEL as MODEL_626 } from "../dedupeClassifier.js";
import { VENUE_MODEL, BATCH_SIZE as BATCH_SIZE_945 } from "../venues.js";
import { RANK_MODEL, RANK_CHUNK } from "../rank.js";
import { SEARCH_MODEL, CURATE_MODEL } from "../providers/google.js";
import { CONCURRENT_HOSTS, RUN_BUDGET_MS } from "../adapters/render.js";
import { SOURCE_CONCURRENCY } from "../adapters/collect.js";
import { MAX_EVALUATIONS as MAX_EVALUATIONS_533, MIN_DATED, MIN_IN_WINDOW } from "../adapters/triage.js";
import { MAX_WEB_SEARCHES } from "../providers/anthropic.js";
import { MAX_TOOL_CALLS } from "../providers/openai.js";
import { HIT_WINDOW_WEEKS, GRACE_DAYS, LEDGER_WEEKS, MIN_HISTORY_WEEKS } from "../sourceYield.js";
import { PAIR_BATCH_SIZE, MAX_PAIRS, MAYBE_MIN } from "../dedupe.js";
import { MAX_CONCURRENT, TIMEOUT_MS } from "../locality.js";
import { WEEK_FILE_LIMIT, DAY_FILE_LIMIT } from "../ai.js";
...
describe("pipeline config snapshot", () => {
  it("matches expected hardcoded values", () => {
    ...
    assert.deepStrictEqual(RUN_BUDGET_MS, Number(process.env.RENDER_RUN_BUDGET_MS ?? 20 * 60_000)); // `scrape.render.runBudgetMs`
    ...
    assert.deepStrictEqual(CONCURRENT_HOSTS_99, Number(process.env.PROBE_CONCURRENT_HOSTS ?? 20)); // `stages.probe.concurrentHosts`
